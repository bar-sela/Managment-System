# Generated by Django 4.2.7 on 2024-09-07 23:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(blank=True, default='course.jpg', null=True, upload_to='course-file')),
                ('image', models.FileField(blank=True, default='course_image.jpg', null=True, upload_to='course-file')),
                ('title', models.CharField(max_length=200)),
                ('description', models.TextField(blank=True, null=True)),
                ('price', models.DecimalField(decimal_places=2, default=0.0, max_digits=12, validators=[django.core.validators.MinValueValidator(0.0, message='Price must be greater than or equal to 0')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.DurationField(blank=True, null=True, validators=[api.models.validate_non_negative_duration])),
